  ...
  return (
    <>
      <HeroBanner
        ...
        backgroundImage="path/to/services-background.jpg"
      />
      <Container fluid>
                  ...
                  <Card.Body className="d-flex flex-column justify-content-between">
                    <div>
                      ...
                      <Card.Text className="services-card-text">
                        Enchanted Gardener offers a wide range of expert gardening,
                        maintenance, hardscaping, design, and installation services.
                        Whether you need weekly care like weeding or a complete
                        landscape transformation, our dedicated team is here to bring
                        your outdoor vision to life. With over 14 years of experience,
                        we proudly serve the community, turning ordinary spaces into
                    ...
                    <Container
                      ...
                      <Button className="services-button" variant="primary" size="lg">
                        View Services
                      </Button>
                    </Container>
                  </Card.Body>
